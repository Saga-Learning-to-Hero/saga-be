...
public class AiAnalysisReadService {
	private final AiAnalysisRunRepository runs; private final AiAnalysisEvidenceRepository evidence; private final AiAnalysisProviderDecisionRepository decisions; private final ProjectDataAuthorization authorization;
	public AiAnalysisReadService(AiAnalysisRunRepository runs, AiAnalysisEvidenceRepository evidence, AiAnalysisProviderDecisionRepository decisions, ProjectDataAuthorization authorization) { this.runs = runs; this.evidence = evidence; this.decisions = decisions; this.authorization = authorization; }
	...
	private static AiAnalysisResponse toResponse(AiAnalysisRun run, List<AiAnalysisEvidence> rows, AiAnalysisProviderDecision decision) {
