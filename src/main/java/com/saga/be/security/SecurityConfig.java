	...
	public SecurityFilterChain securityFilterChain(
		...
		http.cors(Customizer.withDefaults())
				...
				.authorizeHttpRequests(auth -> auth.requestMatchers(HttpMethod.OPTIONS, "/**")
						...
						.permitAll()
						.requestMatchers("/privacy", "/terms", "/legal/**")
						.permitAll()
						...
						.hasRole("ADMIN")
						.requestMatchers(HttpMethod.POST, "/api/lecturer/notifications/all-courses")
						.hasRole("LECTURER")
						.requestMatchers(HttpMethod.POST, "/api/lecturer/courses/*/notifications")
						.hasRole("LECTURER")
						.requestMatchers(HttpMethod.POST, "/api/lecturer/teams/*/notifications")
						.hasRole("LECTURER")
						.requestMatchers(HttpMethod.POST, "/api/lecturer/courses/*/students/*/notifications")
						.hasRole("LECTURER")
						.requestMatchers("/api/lecturer/**")
						.hasAnyRole("LECTURER", "ADMIN")
						.requestMatchers("/api/student/**")
						.hasRole("STUDENT")
						.requestMatchers(HttpMethod.GET, "/api/projects/*/group-weights")
						.hasAnyRole("LECTURER", "ADMIN")
						.requestMatchers(HttpMethod.PUT, "/api/projects/*/group-weights")
						.hasAnyRole("LECTURER", "ADMIN")
						.requestMatchers(HttpMethod.POST, "/api/teams/*/contribution-override")
						.hasAnyRole("LECTURER", "ADMIN")
						.anyRequest()
						.authenticated())
