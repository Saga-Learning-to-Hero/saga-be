...
/** Opt-in entity-versus-schema validation after disposable MySQL has migrated through V36.
 * It deliberately performs Hibernate validate only; it never creates or updates a schema. */
@DataJpaTest
...
class V36MysqlHibernateValidateIT {
	...
	@Test
	void hibernateSchemaMatchesV36() {
		// Context startup performs ddl-auto=validate against the Flyway V36 schema.
	}
}
