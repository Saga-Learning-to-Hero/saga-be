 ...
 * through V33.  V32/V33 introduce the BYOK settings/credential tables and credential provenance;
 * H2 create-drop cannot prove that their Flyway DDL has the exact MySQL column types required by
 * the JPA mappings.  See {@code scripts/verify_v33_mysql.sh}.
 */
@DataJpaTest
...
class V33MysqlHibernateValidateIT {
	...
	@Test
	void hibernateSchemaMatchesV33() {
		// Context startup is the assertion: Hibernate ddl-auto=validate checks all mapped tables,
		// including CourseAiSettings, CourseAiProviderCredential and credential provenance fields.
	}
}
