...
| GET | `/api/student/courses/{courseId}/dashboard` | Session | STUDENT | Student Dashboard Phase A+B1+B2+D1+D2 (`actionableAlerts` = MSR_ANOMALY, GHOSTING_WARNING, PEER_REVIEW_PENDING; no `contribution`) | `StudentDashboardController` |
